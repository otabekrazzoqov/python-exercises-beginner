...
#from soz_topish_functions import play
...
#import telebot
#TOKEN = '6019954749:AAER-rFZQcyzs0uEOpbaHrj1yaRUzsIEyAM'
...
# agar matn.isascii() true bo'lsa         
# matn lotincha aks holda matn kirillcha
...
#parameters (make, model, and year) and assigns them to instance variables.
 
#We also define a method info that returns a formatted string with information 
#about the car. 

#We then create an object my_car of the Car class, passing in
#values for the constructor parameters. Finally, we call the info method on 
#the my_car object and print the result to the console.
...
#x = 10
#x_json = json.dumps(x)      #dumps funksiyasi qiymatni json formatiga o'tkazadi
                            # json formatida qiymat string shaklida bo'ladi
#y = 5.5
#y_json = json.dumps(y)      #json modulidagi dumps funksiyasi 
...
#sonlar = (12, 45, 23, 67)                  #tuple bolgan O'zgarmas ro'yxat ham 
#sonlar_json = json.dumps(sonlar)           #json da string ko'rinishida bo'ladi
...
#bemor_json = json.dumps(bemor, indent=5)   # bemor nomli lug'atni json 
#print(bemor_json)                          # ko'rinishiga o'tkazamiz

#with open('sonlar.json','w') as f:         # json o'zgaruvchini fayl 
#    json.dump(sonlar,f)                    # shaklida saqlash dump yordamida

#bemor2 = json.loads(bemor_json)            # loads funksiyasi json formatidagi
                                           # faylni python faylga aylantiradi

#******************************************************************************

# Ushbu o'zgaruvchini JSON ko'rinishida saqlang va JSON matnini 
# konsolga chiqaring: 
...
#print(data_json)
#ith open('data.json', 'w') as f:          # data nomli lug'atni json shaklida 
#    json.dump(data, f)                     # file qilib saqlash
...
#talaba = json.loads(talaba_json)           # json moduli loads funksiyasi 
#print(talaba)                              # yordamida json faylni python
#with open('talaba.json','w') as f:          # lug'at shakliga o'tkaziladi
#    json.dump(talaba, f)


#Yuqoridagi ikki o'zgaruvchini alohida JSON fayllarga saqlandi
...
# saqlangan. Ularning har birini alohida qatordan "Ism Familiya, n-kurs, 
# Fakultet talabasi" ko'rinishida konsolga chiqaring.

#students = {"student": [{"id": "01", "name": "Tom", "lastname": "Price", "year": 4, "faculty": "Engineering"}, {"id": "02", "name": "Nick", "lastname": "Thameson", "year": 3, "faculty": "Computer Science"}, {"id": "03", "name": "John", "lastname": "Doe", "year": 2, "faculty": "ICT"}]}
#students_json = json.dumps(students, indent=5)
#print(students_json)
...
#try:
#    yosh = int(yosh)
#except ValueError:  #ValueError yuz bergan holda
#    print("siz butun son kiritmadingiz:")
#else:
...
#    print(mevalar[4])
#except IndexError:
#    print(f"Ro'yxatda mavjud mevalar soni: {len(mevalar)}") 
